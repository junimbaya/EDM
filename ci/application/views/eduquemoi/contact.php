...
<!-- contact -->
	<div class="contact">
		<div class="container">
			<h3 class="tittle-agileits-w3layouts">Rester en contact</h3>
					...
					<div class="col-md-6 w3_agileits_contact_left">
						<span class="input input--akira">
							...
							<label class="input__label input__label--akira" for="input-22">
								<span class="input__label-content input__label-content--akira">Votre nom</span>
							</label>
						</span>
						<span class="input input--akira">
						...
						<span class="input input--akira">
							...
							<label class="input__label input__label--akira" for="input-24">
								<span class="input__label-content input__label-content--akira">Votre Sujet</span>
							</label>
						</span>
					</div>
