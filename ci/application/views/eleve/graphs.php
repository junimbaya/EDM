        <div id="page-wrapper">
            <div class="col-md-12 text-center label label-info">
                <h1>DIFFERENT DIAGRAMME :</h1>
            </div>
        <div class="graphs">
	    <div class="graph_box">
    ...
    <script>
		...
		var lineChartData = {
			labels : ["jo","junior","ange","antho","gradie","grace","chris"],
			datasets : [
				{
					fillColor : "#00aced",
					strokeColor : "#00aced",
	...
	var chartData = [
		...
		var radarChartData = {
			labels : ["pop","ange","jenny","claudia","marie","laura","sha"],
			datasets : [
				{
					fillColor : "#3b5998",
					strokeColor : "#3b5998",
